...
eMF("e1d1","dd.00","<NOBR>ABOUT US</NOBR>","");
eLK("e1d1d1","ddi","<NOBR>Home</NOBR>","asActiveSales.html");
...
//eLK("e2d2d3","ddi","<NOBR>Delete Employee</NOBR>","asAddEmp.html");
eLK("e2d2d4","ddi","<NOBR>View Employee</NOBR>","asViewEmp.php");
...
eDW("</TD>");
eDW("<TD class='menuTreeBox'  width='90' valign='top'>");
eMF("e6d6","dd.00","<NOBR>INWARD</NOBR>","");
...
eLK("e7d7d1","ddi","<NOBR>Outward Product Details</NOBR>","asViewShortVendor.html");
