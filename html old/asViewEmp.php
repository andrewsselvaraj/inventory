...
while($row = mysql_fetch_array($result))
  {
  echo "<tr>";
  echo "<td><span class=disp><a href='asEditEmp.php?employeeid=" . $row['employeeid'] . "'>" . $row['employeeid'] . "</a></span></td>";
  //echo "<td><span class=disp>" . $row['employeeid'] . "</span></td>";
  echo "<td><span class=disp>" . $row['firstname'] . "</span></td>";
  echo "<td><span class=disp>" . $row['lastname'] . "</span></td>";
  echo "<td><span class=disp>" . $row['dob'] . "</span></td>";
  echo "<td><span class=disp>" . $row['designation'] . "</span></td>";
  echo "<td><span class=disp>" . $row['joindate'] . "</span></td>";
  echo "<td><span class=disp>" . $row['leavingdate'] . "</span></td>";
