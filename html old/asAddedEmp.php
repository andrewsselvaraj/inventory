...
$dob= $_POST['orderdate1'];
$designation = $_POST['designation'];
$joindate = $_POST['orderdate2'];
$leavingdate= $_POST['orderdate3'];
...
$sql="INSERT INTO employee(employeeid,firstname,lastname,dob,designation,joindate,leavingdate,address,state,country,phone,fax,email) VALUES ('$employeeid','$firstname','$lastname','$dob','$designation','$joindate','$leavingdate','$address','$state','$country', '$phone', '$fax', '$email')";
