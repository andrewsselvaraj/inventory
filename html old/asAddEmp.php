         ...
         <TR>
                ...
                <TD WIDTH=780 valign=top >
								...
								<tr >
                                        ...
                                        <td><INPUT  type="text" size="20" maxlength="50" name="employeeid"  class="plain">  </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>First Name</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="firstname"  class="plain">  </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>Last Name</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="lastname"  class="plain">  </td>
                                </tr>
								<tr >
                                        <td><span class=caption>Date Of Birth</span></td>
                                        <td> <script>DateInput('orderdate1', true, 'YYYY-MM-DD')</script>
										
										<!-- <INPUT  type="text" size="20" maxlength="50" name="dob"  class="plain">  --> </td>
                                </tr>
                                <tr >
						...
						<option value="MD"> MD</option>
                                 ...
                                 <tr >
										...
										<!-- <INPUT  type="text" size="20" maxlength="50" name="joindate"  class="plain"> -->  </td>
                                </tr>
								<tr >
                                        <td><span class=caption>Leaving Date</span></td>
                                        <td><script>DateInput('orderdate3', true, 'YYYY-MM-DD')</script>
										
										<!-- <INPUT  type="text" size="20" maxlength="50" name="leavingdate"  class="plain"> -->  </td>
                                </tr>
				...
				<!--  <INPUT TYPE=TEXT NAME="joinyyyy" SIZE=4 class="plain">  </FONT></FONT></FONT></P> </td>
					...
					<OPTION VALUE="january" SELECTED>January</OPTION>
                                ...
                                <tr >
                                        ...
                                        <td> <select name=country class="plain"><option value="select" selected>select</option><option value="india"> INDIA </option><option value="Malaysia"> Malaysia </option></select></td>
                                </tr>
                                <tr >
                                ...
                                <tr >
                                        ...
                                        <td><input type=textbox name=fax class="plain">  <span class=caption> (Optional) </span></td>
                                </tr>
                                <tr >
                                        <td><span class=caption>E Mail</span></td>
                                        <td><input type=textbox name=email class="plain">  </td>
                                </tr>
                                <tr >
