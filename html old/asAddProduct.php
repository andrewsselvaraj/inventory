...
<form action="asAddedProduct.php" method="post">
        ...
        <TR>
                ...
                <TD WIDTH=780 valign=top >
								...
								<tr >
                                        ...
                                        <td><INPUT  type="text" size="20" maxlength="50" name="product_id" class="plain">  </td>
                                </tr>

<tr >
                                        <td><span class=caption>product_name</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="product_name" class="plain">  </td>
                                </tr>

<tr >
                                        <td><span class=caption>Product_detail</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="product_detail" class="plain">  </td>
                                </tr>
								<tr >
                                        <td><span class=caption>model</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="model" class="plain">  </td>
                                </tr>
<tr >
                                        <td><span class=caption>material_type</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="material_type" class="plain">  </td>
                                </tr>
<tr >
                                        <td><span class=caption>quantity</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="quantity" class="plain">  </td>
                                </tr>


<tr >
                                        <td><span class=caption>calculation_unit</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="calculation_unit" class="plain">  </td>
                                </tr>

<tr >
                                        <td><span class=caption>current_rate</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="current_rate" class="plain">  </td>
                                </tr>

<tr >
                                        <td><span class=caption>created_by</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="created_by" class="plain">  </td>
                                </tr>
...
<tr >
                                        ...
                                        <td><INPUT  type="text" size="20" maxlength="50" name="status" class="plain">  </td>
                                </tr>
