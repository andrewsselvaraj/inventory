...
<b><font CLASS="css">&nbsp;Inventory</font><font CLASS="css1">Management</font></b><sup><b>TM</b></sup>
        ...
        <TR>
				...
				<tr align=center><td><span class=head>Select any one option below<span></td></tr>


                                </table>
                                <table  align=center border=0  width=630  cellspacing=0>
								<!-- <td><span class=disp><a href='asEditSupplier.php?supplier_id=" . $row['supplier_id'] . "'>" . $row['supplier_id'] . "</a></span></td>"; -->
								<?
								php
								echo "<td><span class=disp><a href='asEditSupplier.php?supplier_id=" . $row['supplier_id'] . "'>Edit</a></span></td>";
//<tr><td><a href="asEditSupplier.php">Edit</a></td></tr> -->
<tr><td><a href="asDeleteSupplier.php">Delete</a></td></tr>
?>
