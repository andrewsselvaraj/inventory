...
$sql="INSERT INTO product(product_id,product_name,product_detail,model,material_type,quantity,calculation_unit,current_rate,created_by,created_date,status) VALUES ('$product_id','$product_name','$product_detail','$model','$material_type','$quantity','$calculation_unit','$current_rate','$created_by','$created_date', '$status')";
