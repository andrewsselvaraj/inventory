...
?>
<form action="asDeleteCustomer.php" method="post">
<!-- <form  method='get'> -->
...
<!-- <input type="text" name="Name" value="<?php echo $Name; ?>">  -->
	  ...
	  <table align="center">
                                <tr>
                                        ...
                                        <td align="center"><br><span class=caption><input Type=submit name=Submit value=Delete class="plain" onClick = "javascript: return confirm('Are you SURE want to delete the data?');">
