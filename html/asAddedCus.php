...
$sql="INSERT INTO customer_info(customer_id,customer_name,customer_type,customer_detail,website,created_by,created_date,status) VALUES ( '$customer_id','$customer_name','$customer_type','$customer_detail','$website','$created_by','$created_date','$status')";
