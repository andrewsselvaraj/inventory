...
while($row = mysql_fetch_array($result))
  ...
  echo "<td><span class=disp><a href='asEditCustomer1.php?customer_id=" . $row['customer_id'] . "'>" . $row['customer_id'] . "</a></span></td>";
  echo "<td><span class=disp>" . $row['customer_name'] . "</span></td>";
  echo "<td><span class=disp>" . $row['customer_type'] . "</span></td>";
  echo "<td><span class=disp>" . $row['customer_detail'] . "</span></td>";
