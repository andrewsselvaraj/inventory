...
$sql="INSERT INTO employee_info(id,employee_id,first_name,last_name,dob,designation,join_date,leave_date,address,state,country,phone,fax,email) VALUES ('$id','$employeeid','$firstname','$lastname','$dob','$designation','$joindate','$leavingdate','$address','$state','$country', '$phone', '$fax', '$email')";
