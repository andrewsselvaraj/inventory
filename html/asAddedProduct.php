...
$created_date= $_POST['orderdate'];
$status= $_POST['status'];
//$fax= $_POST['fax'];
//$email= $_POST['email'];


$sql="INSERT INTO product_info(pk_product_id,product_name,product_detail,model,material_type,quantity,calculation_unit,current_rate,created_by,created_date,status) VALUES ('$product_id','$product_name','$product_detail','$model','$material_type','$quantity','$calculation_unit','$current_rate','$created_by','$created_date', '$status')";
