...
<form action="asInWardProcess.php" method="post">
                                <?php
...
echo "Supplier : <SELECT name='supplier_id' class='plain'>";
	  
while($row = mysql_fetch_array($result))
  {
 echo "<OPTION VALUE=".$row['pk_supplier_id'].">".$row['supplier_name']."</OPTION>";
  }
echo "</SELECT>";
...
<input type=hidden name=process_type value="I">

<input type=submit value="Product Inward to Company Store">
</form>
