...
$sql="UPDATE employee_info SET id='$id', employee_id='$employeeid', first_name='$firstname', last_name='$lastname', dob='$dob', designation='$designation', join_date='$joindate', leave_date='$leavingdate', address='$address', state='$state', country='$country', phone='$phone', fax='$fax', email='$email' WHERE employee_id='$employeeid'";
