...
?>
<form action='asDeleteEmployee.php' method='post'>
...
?>
								...
								<tr >
                                        ...
                                        <td><INPUT  type="text" size="20" maxlength="50" name="employeeid" value="<?php echo $employeeid;?>" class="plain">  </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>First Name</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="firstname" value="<?php echo $firstname;?>" class="plain">  </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>Last Name</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="lastname" value="<?php echo $lastname;?>" class="plain">  </td>
                                </tr>
								<tr >
                                        <td><span class=caption>Date Of Birth</span></td>
                                        <!-- <td> <script>DateInput('orderdate1', true, 'YYYY-MM-DD')</script><?php echo $dob;?> -->
										
										<td><INPUT  type="text" size="20" maxlength="50" name="dob" value="<?php echo $dob;?>" class="plain"> </td>
                                </tr>
                                <!-- <tr >
                                        
																				<td><span class=caption>Designation</span></td>
                                        <td> <select name=designation value="<?php echo $designation;?>"  class="plain">
						...
						<option value="MD"> MD</option>
					            ...
					            <tr >
                                        <td><span class=caption>Designation</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="designation" value="<?php echo $designation;?>" class="plain"> </td>
                                </tr>
                                
                                 <tr >
                                        <td><span class=caption>Join Date</span></td>
                                        <!-- <td><script>DateInput('orderdate2', true, 'YYYY-MM-DD')</script><?php echo $joindate;?> -->
										
										<td><INPUT  type="text" size="20" maxlength="50" name="joindate" value="<?php echo $joindate;?>"  class="plain">   </td>
                                </tr>
								<tr >
                                        <td><span class=caption>Leaving Date</span></td>
                                        <!-- <td><script>DateInput('orderdate3', true, 'YYYY-MM-DD')</script><?php echo $leavingdate;?> -->
										
										<td><INPUT  type="text" size="20" maxlength="50" name="leavingdate" value="<?php echo $leavingdate;?>"  class="plain">   </td>
                                </tr>
				...
				<!--  <INPUT TYPE=TEXT NAME="joinyyyy" SIZE=4 class="plain">  </FONT></FONT></FONT></P> </td>
					...
					<OPTION VALUE="january" SELECTED>January</OPTION>
                                ...
                                <tr >
                                        ...
                                        <td><textarea name=address class="plain"><?php echo $address;?></textarea> </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>State</span></td>
                                        <td><input type=textbox name=state value="<?php echo $state;?>" class="plain"> </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>Country</span></td>
                                        <td><input type=textbox name=country value="<?php echo $country;?>" class="plain"> </td>
                                </tr>

                                <!-- <tr >
                                        <td><span class=caption>Country</span></td>
                                        <td> <select name=country value="<?php echo $country;?>" class="plain"><option value="value="<?php echo $country;?>""> </option><option value="value="<?php echo $country;?>"">  </option></select></td>
                                </tr> -->
                                <tr >
                                        <td><span class=caption>Phone</span></td>
                                        <td><input type=textbox name=phone value="<?php echo $phone;?>" class="plain">  </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>Fax </span></td>
                                        <td><input type=textbox name=fax value="<?php echo $fax;?>" class="plain">  <span class=caption> (Optional) </span></td>
                                </tr>
                                <tr >
                                        <td><span class=caption>E Mail</span></td>
                                        <td><input type=textbox name=email value="<?php echo $email;?>" class="plain">  </td>
                                </tr>
                               
								</table>
	  <table align="center">
								<tr >
                                        <br><td align=right><span class=caption><input Type=submit name=Submit value=Delete class="plain" onClick = "javascript: return confirm('Are you SURE want to delete the data?');"></span></td>
