...
$sql="INSERT INTO inventory(fk_company_id,fk_branch_id,customer_id,supplier_id,fk_product_id,quantity,io_type,created_by,created_date,status) VALUES ('$fk_company_id','$fk_branch_id','$customer_id','$supplier_id','$product_id','$qty','$process_type','created_by','2013-12-12','1')";
