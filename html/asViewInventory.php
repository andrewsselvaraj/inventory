...
while($row = mysql_fetch_array($result))
  ...
  echo "<td><span class=disp>" . $row['supplier_id'] . "</a></span></td>";
   echo "<td><span class=disp>" . $row['customer_id'] . "</a></span></td>";
  echo "<td><span class=disp>" . $row['quantity'] . "</span></td>";
  
  echo "<td><span class=disp>" . $row['io_type'] . "</span></td>";
