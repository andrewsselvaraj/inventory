...
$sql="INSERT INTO supplier(supplierid,suppliername,productid,productname,datesupplied,address,state,country,phone) VALUES ('$supplierid','$suppliername','$productid','$productname','$datesupplied','$address','$state','$country', '$phone')";
