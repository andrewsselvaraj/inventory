...
<b><font CLASS="css">&nbsp;Inventory</font><font CLASS="css1">Management</font></b><sup><b>TM</b></sup>
        ...
        <TR>
                ...
                <TD WIDTH=780 valign=top >
                                <table bgcolor="#336699" WIDTH=780 ><tr ><td><span class=title>List Employee information </span></td><td align=right><a  href="asLogout.html"><span class=headwhite>Logout</span></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td></tr></table>
...
while($row = mysql_fetch_array($result))
  ...
  echo "<td><span class=disp><a href='asEditEmp1.php?employeeid=" . $row['employee_id'] . "'>" . $row['employee_id'] . "</a></span></td>";
  //echo "<td><span class=disp>" . $row['employeeid'] . "</span></td>";
  echo "<td><span class=disp>" . $row['first_name'] . "</span></td>";
  echo "<td><span class=disp>" . $row['last_name'] . "</span></td>";
  echo "<td><span class=disp>" . $row['dob'] . "</span></td>";
  echo "<td><span class=disp>" . $row['designation'] . "</span></td>";
  echo "<td><span class=disp>" . $row['join_date'] . "</span></td>";
  echo "<td><span class=disp>" . $row['leave_date'] . "</span></td>";
  ...
  echo "<td><span class=disp>" . $row['fax'] . "</span></td>";
  echo "<td><span class=disp>" . $row['email'] . "</span></td>";
