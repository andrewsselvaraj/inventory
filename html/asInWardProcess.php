...
$sql="INSERT INTO inventory(fk_company_id,fk_branch_id,supplier_id,fk_product_id,customer_id,quantity,io_type,created_by,created_date,status) VALUES ('$fk_company_id','$fk_branch_id','$supplier_id','$fk_product_id','$customer_id','$qty','$process_type','created_by',now(),'1')";
