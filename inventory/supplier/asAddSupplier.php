...
<form name=myform action='asAddedSupplier.php' method='post' onSubmit="return valForm()">
        ...
        <TR>
                ...
                <TD WIDTH=780 valign=top >
                                ...
                                <tr >
                                        ...
                                        <td><INPUT  type="text" size="20" maxlength="50" name="supplier_id" class="plain">  </td>
                                </tr>
                                <tr >
                                        <td><span class=caption>Supplier_name</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="supplier_name" class="plain">  </td>
                                </tr>
								 <tr >
                                        <td><span class=caption>Supplier_type</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="supplier_type" class="plain">  </td>
                                </tr>
								 <tr >
                                        <td><span class=caption>Supplier_Detail</span></td>
										<td><textarea name="supplier_detail" class="plain"></textarea>  </td>
                                        
                                </tr>
								<tr >
                                        <td><span class=caption>Website</span></td>
                                        <td><INPUT  type="text" size="20" maxlength="50" name="website" class="plain">  </td>
                                </tr>
                                ...
                                <tr >
										...
										<td><INPUT  type="text" size="20" maxlength="50" name="created_date" class="plain">  </td>
                                </tr>
                                <!-- <tr >
                                ...
                                <tr >
                                        ...
                                        <td><input type=textbox name="status" class="plain">  </td>
                                </tr>
